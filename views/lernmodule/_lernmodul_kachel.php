...
<? if (true) : ?>
    ...
    <? if (!$coursemodule || !$coursemodule['starttime'] || ($coursemodule['starttime'] <= time()) || $lernmodul->isWritable()) : ?>
        ...
        <div class="module droppable"<?= $background_image ? " style=\"background-image: url('".htmlReady(is_a($background_image, "FileRef") ? $background_image->getDownloadURL() : $background_image)."');\"" : "" ?>
            ...
            <div class="shadow">
                ...
                <? if ($lernmodul->isWritable()) : ?>
                    ...
                    <?= Icon::create("mobile-sidebar", "info_alt")->asImg(20, array('class' => "text-bottom")) ?>
                <? endif ?>
            </div>
        </div>
